...
import { Model__get_ContentAsString, Model__get_ContentType, Collections_all, ModelModule_isValid, ModelModule_hasValidToTime, ModelModule_hasValidFromTime, TimeZone, SearchInterval, SearchMode, ModelModule_hasValidId } from "./Model.fs.js";
...
import { Option as Option_3, content as content_1 } from "./.fable/Fulma.2.10.0/Elements/Content.fs.js";
import { TableOption, table } from "./.fable/Fulma.2.10.0/Elements/Table.fs.js";
import react$002Djson$002Dview from "react-json-view";
import react$002Dxml$002Dviewer from "react-xml-viewer";
...
export function showStatus(model, dispatch) {
    ...
    return column(empty(), singleton(content_1(empty(), ofArray([react.createElement("h5", {}, toText(printf("Status: %s"))(status)), react.createElement("p", {}, text_2)]))));
}
...
export function showContent(model, dispatch) {
    let content;
    const matchValue = Model__get_ContentType(model);
    switch (matchValue.tag) {
        case 1: {
            content = react.createElement(react$002Djson$002Dview, {
        ...
        case 2: {
            content = react.createElement(react$002Dxml$002Dviewer, {
                xml: Model__get_ContentAsString(model),
            });
            break;
        }
        default: {
    ...
    const modifiers = ofArray([new Modifier_IModifier(5, new Screen(0), new TextAlignment_Option(2)), new Modifier_IModifier(1, new Color_IColor(9)), new Modifier_IModifier(3, new Screen(3), new TextSize_Option(5)), new Modifier_IModifier(3, new Screen(2), new TextSize_Option(6)), new Modifier_IModifier(3, new Screen(1), new TextSize_Option(6))]);
    return column(empty(), singleton(div_1(empty(), singleton(react.createElement("div", {
        style: {
            wordWrap: "break-word",
            overflowY: "auto",
    ...
    }, content_1(singleton(new Option_3(3, modifiers)), singleton(react.createElement("p", {}, content))))))));
}
